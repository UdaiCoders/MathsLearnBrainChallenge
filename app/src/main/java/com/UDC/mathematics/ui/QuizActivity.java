...
import com.UDC.mathematics.data.RandomOptionData;
import com.UDC.mathematics.model.HistoryModel;
import com.UDC.mathematics.model.MainModel;
import com.UDC.mathematics.model.QuizModel;
import com.UDC.mathematics.model.SubModel;
import com.UDC.mathematics.model.TextModel;
import com.UDC.mathematics.receiver.NotificationScheduler;
import com.UDC.mathematics.utils.AdVideoInterface;
import com.UDC.mathematics.utils.AnimatorUtils;
import com.UDC.mathematics.utils.CenterLineTextView;
import com.UDC.mathematics.utils.CenteredToolbar;
import com.UDC.mathematics.utils.ConnectionDetector;
import com.UDC.mathematics.utils.Constant;
import com.UDC.mathematics.utils.ConstantDialog;
import com.UDC.mathematics.utils.ExitInterface;
...
import static com.UDC.mathematics.utils.AdsInfo.loadInterstitialId;
import static com.UDC.mathematics.utils.AdsInfo.loadRewarded;
import static com.UDC.mathematics.utils.Constant.DELAY_SEOCND;
import static com.UDC.mathematics.utils.Constant.getPlusScore;
import static com.UDC.mathematics.utils.Constant.setDefaultLanguage;
...
public class QuizActivity extends BaseActivity implements View.OnClickListener, AdVideoInterface, ExitInterface {
    ...
    public void videoShow() {
        ...
        mRewardedAd.show(QuizActivity.this, rewardItem -> {
            isEarn=true;
...
//    }
    ...
    private void CallNewInsertial() {
        ...
        if (cd.isConnectingToInternet()) {
            ...
            loadInterstitialId(QuizActivity.this, interstitialAd -> mInterstitialAd = interstitialAd);
...
//    }
    ...
    public void setAddViews() {
        loadRewarded(QuizActivity.this, rewardedAd -> mRewardedAd = rewardedAd);
    ...
    public class GetAllData extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            ...
            for (int i = 0; i < Constant.DEFAULT_QUESTION_SIZE; i++) {
                ...
                Log.e("quizModel===", "" + tableModel.answer);
